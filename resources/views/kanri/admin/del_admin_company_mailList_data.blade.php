...
@section('content')
        ...
        <div class="dashboard-container">
            <div class="information-section">
                ...
                <form action="{{route('ecoulex.kanri.deleteEditlistmailaddressdetail')}}" method="post" novalidate>
                @csrf <!-- CSRFトークンを含める -->
                        ...
                        @endif
                            <ul>
                                ...
                                <li>
                                    ...
                                    <input type="text" class="email" name="email" value="{{ $mailList[0]->email}}" readonly>
                                </li>

                            </ul>
                            <input type="hidden" name="company_id" value="{{ $mailList[0]->company_id}}">
                            <input type="hidden" name="m_id" value="{{ $m_id }}" readonly>
                        </div>
                    </div>
