...
// ログイン
Route::get('/ecoulex/kanri/loginCompany/', [CompanyLoginController::class, 'showCpmanyLoginForm'])->name('showCpmanyLoginForm');
Route::post('/ecoulex/kanri/loginCompany/', [CompanyLoginController::class, 'login'])->name('login');
